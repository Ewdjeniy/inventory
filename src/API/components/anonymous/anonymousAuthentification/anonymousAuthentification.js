...
class AnonymousAuthentification extends React.Component {
  ...
  renderEnterForm() {
    ...
    ReactDOM.render(
      <div className="authentificationButtons" onClick={() => this.logIn()}>Войти</div>,
        document.getElementById('authentificationButton')
    );  
  }
      ...
      <header className="header">
        <div className="enter">
          ...
          <div id="authentificationButton">
            <div className="authentificationButtons" onClick={() => this.renderEnterForm()}>Войти</div>
          </div>
